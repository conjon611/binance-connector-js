...
For testing purposes, `/sapi/v1/giftcard/*` endpoints can be used in the [Testnet](https://testnet.binance.vision/). Update the `basePath` in your configuration:

```typescript
import { GiftCard, GiftCardRestAPI, GIFT_CARD_REST_API_TESTNET_URL } from '@binance/gift-card';

const configurationRestAPI = {
    apiKey: 'your-api-key',
    apiSecret: 'your-api-secret',
    basePath: GIFT_CARD_REST_API_TESTNET_URL,
};
const client = new GiftCard({ configurationRestAPI });
```
