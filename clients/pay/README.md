...
For testing purposes, `/sapi/v1/pay/*` endpoints can be used in the [Testnet](https://testnet.binance.vision/). Update the `basePath` in your configuration:

```typescript
import { Pay, PayRestAPI, PAY_REST_API_TESTNET_URL } from '@binance/pay';

const configurationRestAPI = {
    apiKey: 'your-api-key',
    apiSecret: 'your-api-secret',
    basePath: PAY_REST_API_TESTNET_URL,
};
const client = new Pay({ configurationRestAPI });
```
