/**
 * Covers the hand-written facade in src/derivatives-trading-usds-futures.ts: which transports get
...
} from '../../src/derivatives-trading-usds-futures';
...
describe('DerivativesTradingUsdsFutures', () => {
    describe('REST API transport', () => {
        it('should not be constructed when no REST configuration is supplied', () => {
            const client = new DerivativesTradingUsdsFutures(
                {} as ConfigurationDerivativesTradingUsdsFutures
            );
