...
For testing purposes, `/sapi/v1/fiat/*` endpoints can be used in the [Testnet](https://testnet.binance.vision/). Update the `basePath` in your configuration:

```typescript
import { Fiat, FiatRestAPI, FIAT_REST_API_TESTNET_URL } from '@binance/fiat';

const configurationRestAPI = {
    apiKey: 'your-api-key',
    apiSecret: 'your-api-secret',
    basePath: FIAT_REST_API_TESTNET_URL,
};
const client = new Fiat({ configurationRestAPI });
```
