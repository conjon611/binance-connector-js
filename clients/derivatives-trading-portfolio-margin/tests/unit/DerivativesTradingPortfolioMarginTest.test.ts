/**
 * Covers the hand-written facade in src/derivatives-trading-portfolio-margin.ts: which transports get
...
} from '../../src/derivatives-trading-portfolio-margin';
...
describe('DerivativesTradingPortfolioMargin', () => {
    describe('REST API transport', () => {
        it('should not be constructed when no REST configuration is supplied', () => {
            const client = new DerivativesTradingPortfolioMargin(
                {} as ConfigurationDerivativesTradingPortfolioMargin
            );
