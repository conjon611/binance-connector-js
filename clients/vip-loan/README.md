...
For testing purposes, `/sapi/v1/loan/*` endpoints can be used in the [Testnet](https://testnet.binance.vision/). Update the `basePath` in your configuration:

```typescript
import { VIPLoan, VIPLoanRestAPI, VIP_LOAN_REST_API_TESTNET_URL } from '@binance/vip-loan';

const configurationRestAPI = {
    apiKey: 'your-api-key',
    apiSecret: 'your-api-secret',
    basePath: VIP_LOAN_REST_API_TESTNET_URL,
};
const client = new VIPLoan({ configurationRestAPI });
```
