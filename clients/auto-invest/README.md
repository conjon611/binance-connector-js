...
For testing purposes, `/sapi/v1/lending*` endpoints can be used in the [Testnet](https://testnet.binance.vision/). Update the `basePath` in your configuration:
...
const configurationRestAPI = {
    apiKey: 'your-api-key',
    apiSecret: 'your-api-secret',
    basePath: AUTO_INVEST_REST_API_TESTNET_URL,
};
const client = new AutoInvest({ configurationRestAPI });
```
