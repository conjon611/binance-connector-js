...
For testing purposes, `/sapi/v1/dci/*` endpoints can be used in the [Testnet](https://testnet.binance.vision/). Update the `basePath` in your configuration:
...
const configurationRestAPI = {
    apiKey: 'your-api-key',
    apiSecret: 'your-api-secret',
    basePath: DUAL_INVESTMENT_REST_API_TESTNET_URL,
};
const client = new DualInvestment({ configurationRestAPI });
```
