/**
 * Covers the hand-written facade in src/derivatives-trading-portfolio-margin-pro.ts: which transports get
...
} from '../../src/derivatives-trading-portfolio-margin-pro';
...
describe('DerivativesTradingPortfolioMarginPro', () => {
    describe('REST API transport', () => {
        it('should not be constructed when no REST configuration is supplied', () => {
            const client = new DerivativesTradingPortfolioMarginPro(
                {} as ConfigurationDerivativesTradingPortfolioMarginPro
            );
