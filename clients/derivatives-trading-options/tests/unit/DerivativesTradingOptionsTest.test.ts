/**
 * Covers the hand-written facade in src/derivatives-trading-options.ts: which transports get
...
} from '../../src/derivatives-trading-options';
...
describe('DerivativesTradingOptions', () => {
    describe('REST API transport', () => {
        it('should not be constructed when no REST configuration is supplied', () => {
            const client = new DerivativesTradingOptions(
                {} as ConfigurationDerivativesTradingOptions
            );
